...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(menuItemClasses, "data-[state=open]:bg-accent", className)}
    {...props}
  >
    {children}
